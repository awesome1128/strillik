...
//		add_action( 'bcn_after_fill', [ $this, 'breadcrumb_remove_current_item' ] );
	...
	public function widgets_init() {
		register_sidebar( array(
			'name'          => esc_html__( 'Single Posts Sidebar', 'strollik5-core' ),
			'id'            => 'sidebar-single-post',
			'description'   => esc_html__( 'Add widgets here to appear in your sidebar on single posts.', 'strollik5-core' ),
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Blog Sidebar', 'strollik5-core' ),
			'id'            => 'sidebar-blog',
			'description'   => esc_html__( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'strollik5-core' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Page Sidebar', 'strollik5-core' ),
			'id'            => 'sidebar-page',
			'description'   => esc_html__( 'Add widgets here to appear in your pages.', 'strollik5-core' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	public function modal_login_register() {
		include_once trailingslashit( STROLLIK5_CORE_PLUGIN_DIR ) . 'templates/modal/login-register-form.php';
	}
	...
	private function set_main_nav_content( $items ) {
		...
		$items .= '<a data-search-toggle="toggle" data-target=".' . $id . '" class="fa fa-search" title="' . __( "search", "strollik5-core" ) . '"></a>';
...
HTML;
	...
	public function render_related_posts() {
		if ( is_active_sidebar( 'sidebar-single-post' ) || ( ! class_exists( 'Strollik5Core' ) && is_active_sidebar( 'sidebar-blog' ) ) ) {
			strollik5_fnc_related_post( 2 );
		} else {
			strollik5_fnc_related_post( 2 );
		}
	}
