<div class="my-avatar">
    ...
    <a id="select-profile-image" class="btn btn-primary btn-block btn-3d"
       href="javascript:;"><?php esc_html_e( 'Update Profile Picture', 'strollik5-core' ); ?></a>

    <span class="profile-img-info"><?php esc_html_e( '*minimum 270px x 270px', 'strollik5-core' ); ?><br/></span>
</div>