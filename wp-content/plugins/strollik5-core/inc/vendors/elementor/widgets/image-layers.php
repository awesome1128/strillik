...
//    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'strollik5-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label' => esc_html__('Select Content', 'strollik5-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'strollik5-core'),
                    'text' => esc_html__('Text Content', 'strollik5-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label' => esc_html__('Upload Image', 'strollik5-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label' => esc_html__('Content', 'strollik5-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Lorem ipsum dolor sit amet', 'strollik5-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('text_color',
            [
                'label' => esc_html__('Color', 'strollik5-core'),
        ...
        $repeater->add_control('img_layers_position',
            [
                'label' => esc_html__('Position', 'strollik5-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'strollik5-core'),
                    'absolute' => esc_html__('Absolute', 'strollik5-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label' => esc_html__('Horizontal Offset', 'strollik5-core'),
                'type' => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'strollik5-core'),
                'size_units' => ['px', "em", '%'],
                'range' => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label' => esc_html__('Vertical Offset', 'strollik5-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'strollik5-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', "em", '%'],
                'range' => [
        ...
        $repeater->add_control('img_layers_link_selection',
            [
                'label' => esc_html__('Link Type', 'strollik5-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label' => esc_html__('Degrees', 'strollik5-core'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'strollik5-core'),
                'min' => -180,
                'max' => 180,
                'condition' => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label' => esc_html__('Entrance Animation', 'strollik5-core'),
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label' => esc_html__('Animation Delay', 'strollik5-core') . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '',
                'min' => 0,
                'step' => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label' => esc_html__('Mousemove Interactivity', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'strollik5-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label' => esc_html__('Interactivity Style', 'strollik5-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'parallax' => esc_html__('Mouse Parallax', 'strollik5-core'),
                    'tilt' => esc_html__('Tilt', 'strollik5-core'),
                ],
                'default' => 'parallax',
                'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label' => esc_html__('Rate', 'strollik5-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => -10,
                'min' => -20,
                'max' => 20,
                'step' => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'strollik5-core'),
                'separator' => 'after',
                'label_block' => true,
                'condition' => [
                    'img_layers_mouse' => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label' => esc_html__('z-index', 'strollik5-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label' => esc_html__('CSS Classes', 'strollik5-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'strollik5-core'),
            ]
        );
