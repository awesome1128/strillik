...
class OSF_Elementor_Countdown extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Countdown', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => __( 'Countdown', 'strollik5-core' ),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label' => __( 'Due Date', 'strollik5-core' ),
                'type' => Controls_Manager::DATE_TIME,
                'default' => date( 'Y-m-d H:i', strtotime( '+1 month' ) + ( get_option( 'gmt_offset' ) * HOUR_IN_SECONDS ) ),
                /* translators: %s: Time zone. */
                'description' => sprintf( __( 'Date set according to your timezone: %s.', 'strollik5-core' ), Utils::get_timezone_string() ),
            ]
        );
        ...
        $this->add_control(
            'show_minutes',
            [
                'label' => __( 'Minutes', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'strollik5-core' ),
                'label_off' => __( 'Hide', 'strollik5-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label' => __( 'Seconds', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'strollik5-core' ),
                'label_off' => __( 'Hide', 'strollik5-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label' => __( 'Show Label', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'strollik5-core' ),
                'label_off' => __( 'Hide', 'strollik5-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label' => __( 'Custom Label', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Days', 'strollik5-core' ),
                'placeholder' => __( 'Days', 'strollik5-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_days' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hours', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Hours', 'strollik5-core' ),
                'placeholder' => __( 'Hours', 'strollik5-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_hours' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Minutes', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Minutes', 'strollik5-core' ),
                'placeholder' => __( 'Minutes', 'strollik5-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_minutes' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Seconds', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Seconds', 'strollik5-core' ),
                'placeholder' => __( 'Seconds', 'strollik5-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_seconds' => 'yes',
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => __( 'Container Width', 'strollik5-core' ),
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => __( 'Items Width', 'strollik5-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => __( 'Items Height', 'strollik5-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'show_divider',
            [
                'label' => __('Show Divider', 'strollik5-core'),
                'type'  => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'divider_size',
            [
                'label'     => __('Size Divider', 'strollik5-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months' => __( 'Months', 'strollik5-core' ),
            'label_weeks' => __( 'Weeks', 'strollik5-core' ),
            'label_days' => __( 'Days', 'strollik5-core' ),
            'label_hours' => __( 'Hours', 'strollik5-core' ),
            'label_minutes' => __( 'Minutes', 'strollik5-core' ),
            'label_seconds' => __( 'Seconds', 'strollik5-core' ),
        ];
    }
