...
class OSF_Widget_Toggle extends Widget_Toggle {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Toggle Items', 'strollik5-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title' => __( 'Toggle #1', 'strollik5-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik5-core' ),
					],
					[
						'tab_title' => __( 'Toggle #2', 'strollik5-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik5-core' ),
					],
				],
				'fields' => [
					[
						...
						'default' => __( 'Toggle Title' , 'strollik5-core' ),
						'label_block' => true,
					],
					[
						'name' => 'tab_content',
						...
						'default' => __( 'Toggle Content', 'strollik5-core' ),
						'show_label' => false,
					],
				],
		...
		$this->add_control(
			'show_item_first',
			[
				'label' => __( 'Show Item First', 'strollik5-core' ),
        ...
        $this->add_control(
            'event_type',
            [
                'label' => __( 'Event Type', 'strollik5-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'toggle' => 'Toggle',
                    'accordion' => 'Accordion'
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'strollik5-core' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'End', 'strollik5-core' ),
