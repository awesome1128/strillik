...
class OSF_Elementor_Accordion extends Widget_Accordion {
    ...
    public function get_title() {
        return __( 'Opal Accordion', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_title',
            [
                'label' => __( 'Accordion', 'strollik5-core' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Title', 'strollik5-core' ),
                'dynamic' => [
                    'active' => true,
                ],
                'label_block' => true,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Content', 'strollik5-core' ),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label' => __( 'Accordion Items', 'strollik5-core' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => __( 'Accordion #1', 'strollik5-core' ),
                        'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik5-core' ),
                    ],
                    [
                        'tab_title' => __( 'Accordion #2', 'strollik5-core' ),
                        'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik5-core' ),
                    ],
                ],
        ...
        $this->add_control(
            'icon_active',
            [
                'label' => __( 'Active Icon', 'strollik5-core' ),
                'type' => Controls_Manager::ICON,
                'default' => 'fa fa-minus',
                'condition' => [
                    'icon!' => '',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Active Background', 'strollik5-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'title_color_active',
            [
                'label' => __( 'Active Color', 'strollik5-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-accordion .elementor-accordion-icon' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'icon!' => '',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-accordion .elementor-accordion-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon!' => '',
                ],
