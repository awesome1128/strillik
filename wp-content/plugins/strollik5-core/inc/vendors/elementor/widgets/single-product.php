...
class OSF_Elementor_Single_Product extends Elementor\Widget_Base
{
    ...
    {
        return __('Opal Single Product', 'strollik5-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'show_title',
            [
                'label' => __('Change Button Text', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'on',
                'prefix_class'  => 'elementor-change-text-'
            ]
        );
        ...
        $this->add_control(
            'title_text',
            [
                'label' => __( '', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'add to card', 'strollik5-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SWITCHER,
                'selectors' => [
                    '{{WRAPPER}} .single-product .woocommerce-price-text' => 'display: inline-block;',
                ],
                'condition' => [
                    'show_title!'    => ''
                ]
        ...
        $this->add_control(
            'id_product',
            [
                'label' => __('Product id', 'strollik5-core'),
        ...
        $this->add_control(
            'show_title_product',
            [
                'label' => __('Hide Title', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_rating',
            [
                'label' => __('Hide Rating', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_price',
            [
                'label' => __('Hide Price', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_description',
            [
                'label' => __('Hide Description', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_quantity',
            [
                'label' => __('Hide Quantity', 'strollik5-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_4,
                'selector' => '{{WRAPPER}} .single-product div.product .woocommerce-product-details__short-description',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .single-product div.product .woocommerce-product-details__short-description' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .single-product div.product .woocommerce-product-details__short-description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'price_color',
            [
                'label' => __('price Color', 'strollik5-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'data-title', $settings['title_text']);
        ?>
        <?php
        $this->remove_hook();
        $this->add_hook();
