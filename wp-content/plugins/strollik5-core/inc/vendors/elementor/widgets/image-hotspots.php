...
class OSF_Elementor_Image_Hotspots_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('image_hotspots_image_section',
            [
                'label' => esc_html__('Image', 'strollik5-core'),
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_settings',
            [
                'label' => esc_html__('Hotspots', 'strollik5-core'),
            ]
        );
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_horizontal_position',
            [
                'label'      => esc_html__('Horizontal Position', 'strollik5-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_vertical_position',
            [
                'label'      => esc_html__('Vertical Position', 'strollik5-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range'      => [
                    'px' => [
        ...
        $repeater->add_control('image_hotspots_content',
            [
                'label'   => esc_html__('Content to Show', 'strollik5-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'text_editor'         => esc_html__('Text Editor', 'strollik5-core'),
                    'elementor_templates' => esc_html__('Elementor Template', 'strollik5-core'),
                ],
                'default' => 'text_editor'
            ]
        );
        ...
        $repeater->add_control('image_hotspots_tooltips_info',
            ['label'       => esc_html__('Infomation', 'strollik5-core'),
             'type'        => Controls_Manager::WYSIWYG,
             'default'     => 'Lorem ipsum',
             'dynamic'     => ['active' => true],
             'label_block' => true,
        ...
        $repeater->add_control('image_hotspots_tooltips_temp',
            [
                'label'     => esc_html__('Teamplate ID', 'strollik5-core'),
        ...
        $repeater->add_control('image_hotspots_link_switcher',
            [
                'label'       => esc_html__('Link', 'strollik5-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Add a custom link or select an existing page link', 'strollik5-core'),
            ]);

        $repeater->add_control('image_hotspots_link_type',
            [
                'label'       => esc_html__('Link/URL', 'strollik5-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'url'  => esc_html__('URL', 'strollik5-core'),
                    'link' => esc_html__('Existing Page', 'strollik5-core'),
                ],
                'default'     => 'url',
                'condition'   => [
        ...
        $repeater->add_control('image_hotspots_url',
            [
                'label'       => esc_html__('URL', 'strollik5-core'),
        ...
        $repeater->add_control('image_hotspots_link_text',
            [
                'label'       => esc_html__('Link Title', 'strollik5-core'),
        ...
        $this->add_control('image_hotspots_icons_animation',
            [
                'label' => esc_html__('Radar Animation', 'strollik5-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_tooltips_section',
            [
                'label' => esc_html__('Tooltips', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Trigger', 'strollik5-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'click' => esc_html__('Click', 'strollik5-core'),
                    'hover' => esc_html__('Hover', 'strollik5-core'),
                ],
                'default' => 'hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Arrow', 'strollik5-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'strollik5-core'),
                'label_off' => esc_html__('Hide', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Positon', 'strollik5-core'),
                'type'        => Controls_Manager::SELECT2,
                'options'     => [
                    'top'    => esc_html__('Top', 'strollik5-core'),
                    'bottom' => esc_html__('Bottom', 'strollik5-core'),
                    'left'   => esc_html__('Left', 'strollik5-core'),
                    'right'  => esc_html__('Right', 'strollik5-core'),
                ],
                'description' => esc_html__('Sets the side of the tooltip. The value may one of the following: \'top\', \'bottom\', \'left\', \'right\'. It may also be an array containing one or more of these values. When using an array, the order of values is taken into account as order of fallbacks and the absence of a side disables it', 'strollik5-core'),
                'default'     => ['top', 'bottom'],
                'label_block' => true,
                'multiple'    => true
            ]
        ...
        $this->add_control('image_hotspots_tooltips_distance_position',
            [
                'label'   => esc_html__('Spacing', 'strollik5-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('The distance between the origin and the tooltip in pixels, default is 6', 'strollik5-core'),
                'default' => 6,
            ]
        );
        ...
        $this->add_control('image_hotspots_min_width',
            [
                'label'       => esc_html__('Min Width', 'strollik5-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a minimum width for the tooltip in pixels, default: 0 (auto width)', 'strollik5-core'),
            ]
        );

        $this->add_control('image_hotspots_max_width',
            [
                'label'       => esc_html__('Max Width', 'strollik5-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a maximum width for the tooltip in pixels, default: null (no max width)', 'strollik5-core'),
            ]
        );

        $this->add_responsive_control('image_hotspots_tooltips_wrapper_height',
            [
                'label'       => esc_html__('Height', 'strollik5-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', 'em', '%'],
                'range'       => [
                    'px' => [
        ...
        $this->add_control('image_hotspots_anim',
            [
                'label'       => esc_html__('Animation', 'strollik5-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'fade'  => esc_html__('Fade', 'strollik5-core'),
                    'grow'  => esc_html__('Grow', 'strollik5-core'),
                    'swing' => esc_html__('Swing', 'strollik5-core'),
                    'slide' => esc_html__('Slide', 'strollik5-core'),
                    'fall'  => esc_html__('Fall', 'strollik5-core'),
                ],
                'default'     => 'fade',
                'label_block' => true,
            ]
        ...
        $this->add_control('image_hotspots_anim_dur',
            [
                'label'   => esc_html__('Animation Duration', 'strollik5-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation duration in milliseconds, default is 350', 'strollik5-core'),
                'default' => 350,
            ]
        );
        ...
        $this->add_control('image_hotspots_delay',
            [
                'label'   => esc_html__('Delay', 'strollik5-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation delay in milliseconds, default is 10', 'strollik5-core'),
                'default' => 10,
            ]
        );
        ...
        $this->add_control('image_hotspots_hide',
            [
                'label'        => esc_html__('Hide on Mobiles', 'strollik5-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => 'Show',
                'label_off'    => 'Hide',
                'description'  => esc_html__('Hide tooltips on mobile phones', 'strollik5-core'),
                'return_value' => true,
            ]
        );
        ...
        $this->add_control('image_hotspots_infomation_show',
            [
                'label' => esc_html__('Show infomation', 'strollik5-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control('image_hotspots_image_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'strollik5-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_color',
            [
                'label'     => esc_html__('Text Color', 'strollik5-core'),
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_background_color',
            [
                'label'     => esc_html__('Background Color', 'strollik5-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control('image_hotspots_tooltips_wrapper_margin',
            [
                'label'      => esc_html__('Margin', 'strollik5-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
...
//        );
        ...
        $this->start_controls_section('img_hotspots_container_style',
            [
                'label' => esc_html__('Container', 'strollik5-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('img_hotspots_container_padding',
            [
                'label'      => esc_html__('Paddding', 'strollik5-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
