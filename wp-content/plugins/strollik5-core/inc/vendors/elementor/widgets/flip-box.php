...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Flip Box', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Front', 'strollik5-core' ),
            ]
        );

        $this->start_controls_tabs( 'side_a_content_tabs' );

        $this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'strollik5-core' ) ] );
        ...
        $this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'strollik5-core' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background Overlay', 'strollik5-core' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Back', 'strollik5-core' ),
            ]
        );

        $this->start_controls_tabs( 'side_b_content_tabs' );

        $this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'strollik5-core' ) ] );
        ...
        $this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'strollik5-core' ) ] );
        ...
        $this->add_control(
            'flip_effect',
            [
                'label' => __( 'Flip Effect', 'strollik5-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'flip',
                'options' => [
                    'flip' => 'Flip',
        ...
        $this->add_control(
            'flip_direction',
            [
                'label' => __( 'Flip Direction', 'strollik5-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'up',
                'options' => [
                    'left' => __( 'Left', 'strollik5-core' ),
                    'right' => __( 'Right', 'strollik5-core' ),
                    'up' => __( 'Up', 'strollik5-core' ),
                    'down' => __( 'Down', 'strollik5-core' ),
                ],
                'condition' => [
                    'flip_effect!' => [
                        'fade',
        ...
        $this->add_control(
            'flip_3d',
            [
                'label' => __( '3D Depth', 'strollik5-core' ),
        ...
        $this->add_control(
            'icon_rotate',
            [
                'label' => __( 'Icon Rotate', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0,
                    'unit' => 'deg',
