...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'strollik5-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_image',
            [
                'label' => __('Image Box', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            'media_type',
            [
                'label'   => __('Media Type', 'strollik5-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => __('Image', 'strollik5-core'),
                    'svg'   => __('SVG Code', 'strollik5-core'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Hover Wrapper Animation', 'strollik5-core'),
        ...
        $this->add_control(
            'link_download',
            [
                'label' => __('Download Link ?', 'strollik5-core'),
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Image Position', 'strollik5-core'),
...
//        control button
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Animation Background', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            'hover_animation_bg',
            [
                'label' => __('Enable Animation', 'strollik5-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control('bg_animation_duration',
            [
                'label'     => esc_html__('Duration', 'strollik5-core'),
                'type'      => Controls_Manager::NUMBER,
                'title'     => esc_html__('Set the animation duration in milliseconds, default is 1200', 'strollik5-core'),
                'default'   => 1200,
                'condition' => [
                    'hover_animation_bg' => 'yes'
                ]
        ...
        $this->add_control('bg_animation_elasticity',
            [
                'label'     => esc_html__('Elasticity', 'strollik5-core'),
                'type'      => Controls_Manager::NUMBER,
                'default'   => 400,
                'condition' => [
                    'hover_animation_bg' => 'yes'
...
//        end control button
        ...
        $this->add_responsive_control(
            'image_wrapper',
            [
                'label'     => __('Wrapper Size', 'strollik5-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'image_hover_scale',
            [
                'label' => __('Hover Scale', 'strollik5-core'),
                'type'  => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}}:not(:hover) .elementor-image-box-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => __('Color Hover (Wrapper)', 'strollik5-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Transition Duration', 'strollik5-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max'  => 3,
...
//            button
            if (!empty($settings['show_button']) && !empty($settings['icon'])) {
                $this->add_render_attribute('i', 'class', $settings['icon']);
                $this->add_render_attribute('i', 'aria-hidden', 'true');
                $content_icon = '<i ' . $this->get_render_attribute_string('i') . '></i>';
