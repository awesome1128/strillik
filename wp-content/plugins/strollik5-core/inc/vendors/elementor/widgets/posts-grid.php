...
class OSF_Elementor_Post_Grid extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Posts Grid', 'strollik5-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => __('Date', 'strollik5-core'),
                    'post_title' => __('Title', 'strollik5-core'),
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => __('Pagination', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => __('Numbers', 'strollik5-core'),
                    'prev_next'             => __('Previous/Next', 'strollik5-core'),
                    'numbers_and_prev_next' => __('Numbers', 'strollik5-core') . ' + ' . __('Previous/Next', 'strollik5-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Page Limit', 'strollik5-core'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Shorten', 'strollik5-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Previous Label', 'strollik5-core'),
                'default'   => __('&laquo; Previous', 'strollik5-core'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Next Label', 'strollik5-core'),
                'default'   => __('Next &raquo;', 'strollik5-core'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . __('Page', 'strollik5-core') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation" aria-label="<?php esc_attr_e('Pagination', 'strollik5-core'); ?>">
