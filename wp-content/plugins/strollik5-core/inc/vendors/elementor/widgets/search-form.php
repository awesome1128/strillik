...
class OSF_Elementor_Search_Form extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Search Form', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'text_icon' => __( 'Text & Icon', 'strollik5-core' ),
                ],
        ...
        $this->add_responsive_control(
            'button_width',
            [
                'label' => __( 'Button Width', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label' => __( 'Icon Spacing', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
