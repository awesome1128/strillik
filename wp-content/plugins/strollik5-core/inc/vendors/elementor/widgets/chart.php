...
class OSF_Elementor_Chart extends Widget_Base
{
    ...
    {
        return __('Opal Chart', 'strollik5-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'doughnut',
                'options' => [
                    'doughnut' => __('Doughnut', 'strollik5-core'),
                    'pie' => __('Pie', 'strollik5-core'),
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Chart Name', 'strollik5-core'),
                'default' => __('Chart Name', 'strollik5-core'),
            ]
        );
        $repeater->add_control(
            'number',
            [
                'label' => __('Nunber', 'strollik5-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'name' => __('Fundrasing', 'strollik5-core'),
                        'number' => '40',
                        'color' => '#1f9a47',
                    ],
                    [
                        'name' => __('Research and Advoccy', 'strollik5-core'),
                        'number' => '25',
                        'color' => '#37b560',
                    ],
                    [
                        'name' => __('Operations ', 'strollik5-core'),
                        'number' => '15',
                        'color' => '#68d89d',
                    ],
                    [
                        'name' => __('Education & Prevention', 'strollik5-core'),
                        'number' => '10',
                        'color' => '#6bdbc5',
                    ],
                    [
                        'name' => __('Reserve', 'strollik5-core'),
                        'number' => '5',
                        'color' => '#8de8dc',
                    ],
                    [
                        'name' => __('Smart MFG Tech', 'strollik5-core'),
                        'number' => '5',
                        'color' => '#aefff1',
                    ],
                ],
        ...
        $this->start_controls_section(
            'section_canvas',
            [
                'label' => __('Canvas', 'strollik5-core'),
        ...
        $this->add_responsive_control(
            'width_canvas',
            [
                'label' => __('Canvas Size', 'strollik5-core'),
        ...
        $this->add_control(
            'legend_indent',
            [
                'label' => __('Legend Indent', 'strollik5-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'name_color',
            [
                'label' => __('Name Color', 'strollik5-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'name_indent',
            [
                'label' => __('Name Indent', 'strollik5-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'number_color',
            [
                'label' => __('Number Color', 'strollik5-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
