...
class OSF_Elementor_Phone extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Phone', 'strollik5-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Enter your phone', 'strollik5-core'),
                'default'     => __('123 456 789 00', 'strollik5-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('Make a call', 'strollik5-core'),
            ]
        );
