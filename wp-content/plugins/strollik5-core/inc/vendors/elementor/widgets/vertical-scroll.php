...
class OSF_Elementor_Vertical_Scroll extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Vertical Scroll', 'strollik5-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control('content_type',
            [
                'label'         => __('Content Type', 'strollik5-core'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'ids'           => __('Section ID', 'strollik5-core'),
                    'templates'     => __('Elementor Templates', 'strollik5-core')
                ],
                'default'       => 'templates',
                'description'   => __('Choose which method you prefer to insert sections.', 'strollik5-core')
            ]
        );
        ...
        $temp_repeater->add_control('section_template',
            [
                'label'			=> __( 'Elementor Template', 'strollik5-core' ),
                'type'          => Controls_Manager::SELECT,
                'options'       => $options,
                'types' => $types,
                'multiple'      => false,
        ...
        $this->add_control('section_repeater',
            [
                'label'          => __( 'Sections', 'strollik5-core' ),
        ...
        $id_repeater->add_control('section_id',
            [
                'label'			=> __( 'Section ID', 'strollik5-core' ),
        ...
        $this->add_control('dots_tooltips_switcher',
            [
                'label'         => __('Dots Tooltips', 'strollik5-core'),
        ...
        $this->add_control('dots_shape',
            [
                ...
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'circ'          => __('Circles', 'strollik5-core'),
                    'lines'         => __('Lines', 'strollik5-core')
                ],
                'default'       => 'circ',
                'condition'     => [
        ...
        $this->add_control('dots_tooltips',
            [
                'label'         => __('Dots Tooltips Text', 'strollik5-core'),
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
                'description'   => __('Add text for each navigation dot separated by \',\'','strollik5-core'),
                'condition'     => [
                    'dots_tooltips_switcher'    => 'yes'
                ]
            ]
        ...
        $this->add_control('nav_menu_switch',
            [
                'label'         => __('Navigation Menu', 'strollik5-core'),
                'type'          => Controls_Manager::SWITCHER,
                'description'   => __('This option works only on the frontend', 'strollik5-core'),
            ]
        );
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_top',
            [
                'label'         => __('Offset Top', 'strollik5-core'),
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_left',
            [
                'label'         => __('Offset Left', 'strollik5-core'),
                'type'          => Controls_Manager::SLIDER,
                'size_units'    => ['px', '%' ,'em'],
                'selectors'     => [
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_right',
            [
                'label'         => __('Offset Right', 'strollik5-core'),
                'type'          => Controls_Manager::SLIDER,
                'size_units'    => ['px', '%' ,'em'],
                'selectors'     => [
        ...
        $nav_repeater->add_control('nav_menu_item',
            [
                'label'			=> __( 'List Item', 'strollik5-core' ),
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
            ]
        );
        ...
        $this->add_control('nav_menu_repeater',
            [
                'label'          => __( 'Menu Items', 'strollik5-core' ),
                'type'           => Controls_Manager::REPEATER,
        ...
        $this->add_control('navigation_dots_pos',
            [
                'label'         => __('Dots Horizontal Position', 'strollik5-core'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'left'  => __('Left', 'strollik5-core'),
                    'right' => __('Right', 'strollik5-core'),
        ...
        $this->add_control('navigation_dots_v_pos',
            [
                'label'         => __('Dots Vertical Position', 'strollik5-core'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
        ...
        $this->start_controls_section('advanced_settings',
            [
                'label'         => __('Scroll Settings', 'strollik5-core'),
            ]
        );

        $this->add_control('scroll_speed',
            [
                'label'         => __('Scroll Speed', 'strollik5-core'),
                'type'          => Controls_Manager::NUMBER,
                'description'   => __('Set scolling speed in seconds, default: 0.7', 'strollik5-core'),
            ]
        );

        $this->add_control('full_section',
            [
                'label'         => __('Full Section Scroll', 'strollik5-core'),
                'type'          => Controls_Manager::SWITCHER,
                'default'       => 'yes',
            ]
        );
        ...
        $this->add_control('full_section_touch',
            [
                'label'         => __('Full Section Scroll on Touch', 'strollik5-core'),
                'type'          => Controls_Manager::SWITCHER,
                'default'       => 'yes',
                'condition'     => [
                    'full_section'  => 'yes'
        ...
        $this->start_controls_section('navigation_style',
            [
                'label'         => __('Navigation Dots', 'strollik5-core'),
        ...
        $this->start_controls_tab('tooltips_style_tab',
            [
                'label'         => __('Tooltips', 'strollik5-core'),
                'condition' => [
                    'dots_tooltips_switcher'    => 'yes'
                ]
            ]
        ...
        $this->add_control('tooltips_color',
            [
                'label'         => __( 'Tooltips Text Color', 'strollik5-core' ),
        ...
        $this->add_control('tooltips_background',
            [
                'label'         => __( 'Tooltips Background', 'strollik5-core' ),
                'type'          => Controls_Manager::COLOR,
                'scheme'        => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1
        ...
        $this->start_controls_tab('dots_style_tab',
            [
                'label'         => __('Dots', 'strollik5-core'),
            ]
        );

        $this->add_control('dots_color',
            [
                'label'         => __( 'Dots Color', 'strollik5-core' ),
                'type'          => Controls_Manager::COLOR,
                'scheme'        => [
                    'type'  => Scheme_Color::get_type(),
                    'value' => Scheme_Color::COLOR_1
        ...
        $this->add_control('active_dot_color',
            [
                'label'         => __( 'Active Dot Color', 'strollik5-core' ),
                'type'          => Controls_Manager::COLOR,
                'scheme'        => [
                    'type'  => Scheme_Color::get_type(),
        ...
        $this->add_control('dots_border_color',
            [
                'label'         => __( 'Dots Border Color', 'strollik5-core' ),
                'type'          => Controls_Manager::COLOR,
                'scheme'        => [
                    'type'  => Scheme_Color::get_type(),
                    'value'=> Scheme_Color::COLOR_2
