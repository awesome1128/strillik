...
class OSF_Elementor_Header_Group extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Header Group', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'account_config',
            [
                'label' => __( 'Config', 'strollik5-core' ),
            ]
        );
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => __( 'Show wishlist', 'strollik5-core' ),
        ...
        $this->add_control(
            'show_search',
            [
                'label' => __( 'Show search form', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_account',
            [
                'label' => __( 'Show account', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_cart',
            [
                'label' => __( 'Show cart', 'strollik5-core' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            'wishlist_config',
            [
                'label' => __( 'WooCommerce Wishlist', 'strollik5-core' ),
                'condition' => [
                    'show_wishlist!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_subtotal',
            [
                'label'       => __('Show Total', 'strollik5-core'),
                'type'        => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Wishlist', 'strollik5-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'search_config',
            [
                'label' => __( 'Search Form', 'strollik5-core' ),
                'condition' => [
                    'show_search!' => '',
                ],
            ]
        ...
        $this->add_control(
            'skin',
            [
                'label' => __( 'Skin', 'strollik5-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'full_screen',
                'options' => [
                    'classic' => __( 'Classic', 'strollik5-core' ),
                    'minimal' => __( 'Minimal', 'strollik5-core' ),
                    'full_screen' => __( 'Full Screen', 'strollik5-core' ),
                ],
        ...
        $this->add_control(
            'placeholder',
            [
                'label' => __( 'Placeholder', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'separator' => 'before',
                'default' => __( 'Search', 'strollik5-core' ) . '...',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'search' => [
                        'title' => __( 'Search', 'strollik5-core' ),
                        'icon' => 'opal-icon-search',
                    ],
                    'arrow' => [
                        'title' => __( 'Arrow', 'strollik5-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Toggle', 'strollik5-core' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'skin' => 'full_screen',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Text', 'strollik5-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __('Account', 'strollik5-core'),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Wishlist Style', 'strollik5-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background Hover Color', 'strollik5-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Title Hover Color', 'strollik5-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label' => __( 'Search Form Style', 'strollik5-core' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search!' => '',
                ],
        ...
        $this->add_responsive_control(
            'icon_size_minimal',
            [
                'label' => __( 'Icon Size', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
...
//                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Account Style', 'strollik5-core' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_account' => 'yes',
                ],
        ...
        $this->add_control(
            'indicator_style',
            [
                'label' => __( 'INDICATOR', 'strollik5-core' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'indicator_color',
            [
                'label' => __( 'Indicator Color', 'strollik5-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label' => __( 'Cart Style', 'strollik5-core' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_cart' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cart-contents.header-button:not(:hover)' => 'background-color: {{VALUE}};',
                ],
            ...
            <div class="elementor-search-form__container">
                ...
                <?php if ( 'full_screen' === $settings['skin'] ) : ?>
                    <div class="dialog-lightbox-close-button dialog-close-button">
                        ...
                        <span class="elementor-screen-only"><?php esc_html_e( 'Close', 'strollik5-core' ); ?></span>
                    </div>
                <?php endif ?>
            </div>
        </form>
        ...
        <div class="site-header-account">
            ...
            if(is_user_logged_in()) {
                ...
                if(!$settings['show_icon_account']){
                    echo '<span class="text-account ">'. esc_html__('Login','strollik5-core'). '</span>';
                    echo '<span class="line-center">|</span>';
                    echo '<span class="text-account">'. esc_html__('Sign Up','strollik5-core'). '</span>';
                }
            }
