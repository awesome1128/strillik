...
class OSF_Elementor_Mailchimp extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'MailChimp Sign-Up Form', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'hide_text',
            [
                'label'        => __( 'Hide Text', 'strollik5-core' ),
        ...
        $this->add_control(
            'hide_icon',
            [
                'label'        => __( 'Hide Icon', 'strollik5-core' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => __( 'Off', 'strollik5-core' ),
                'label_on'     => __( 'On', 'strollik5-core' ),
                'default'      => '',
        ...
        $this->start_controls_section(
            'setting_mailchmip',
            [
                'label' => __( 'Setting', 'strollik5-core' ),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'row',
                'options'      => [
                    'row'         => __('Horizontal', 'strollik5-core'),
                    'column'           => __('Vertical', 'strollik5-core'),
                ],
        ...
        $this->add_responsive_control(
            'width_form',
            [
                'label'      => __( 'Form Width', 'strollik5-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    '%' => [
                        'min' => 0,
