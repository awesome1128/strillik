...
class OSF_Element_Site_Logo extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'strollik5-core' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'strollik5-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'strollik5-core' ),
                    'customize' => __( 'Custom Logo', 'strollik5-core' ),
                ]
            ]
        );
    ...
    protected function render() {
        ...
        if('site_logo' === $settings['logo_select']){
            ...
            if(preg_match('/\.svg$/m', $custom_logo['url'])){
                $logosvg = file_get_contents(get_attached_file($custom_logo['id']));
            }
