...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'strollik5-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'strollik5-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'strollik5-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'strollik5-core' ),
                    'minimal' => __( 'Minimal', 'strollik5-core' ),
                    'framed' => __( 'Framed', 'strollik5-core' ),
                    'boxed' => __( 'Boxed Icon', 'strollik5-core' ),
                    'flat' => __( 'Flat', 'strollik5-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'rounded' => __( 'Rounded', 'strollik5-core' ),
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'strollik5-core' ),
        ...
        $this->add_responsive_control(
            'row_gap',
            [
                'label'     => __( 'Rows Gap', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'strollik5-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
        ...
        $this->add_control(
            'text_padding',
            [
                'label' => __( 'Text Padding', 'strollik5-core' ),
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'strollik5-core'), $title)?>">
