...
class OSF_Elementor_Image_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Image Gallery', 'strollik5-core');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => __('Image Gallery', 'strollik5-core'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => __('Filter Title', 'strollik5-core'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('List Item', 'strollik5-core'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => __('Add Images', 'strollik5-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => __('Gallery 1', 'strollik5-core'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Infinite Scroll', 'strollik5-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __('Off', 'strollik5-core'),
                'label_on'  => __('On', 'strollik5-core'),
            ]
...
//                'exclude'   => ['custom'],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Images', 'strollik5-core'),
        ...
        $this->add_control(
            ...
            [
                'label'      => __('Image Spacing', 'strollik5-core'),
                'type'       => Controls_Manager::SLIDER,
                'show_label' => false,
                'range'      => [
                    'px' => [
