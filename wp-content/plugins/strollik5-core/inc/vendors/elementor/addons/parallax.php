...
class OSF_Elementor_Parallax {
        ...
        if ($settings['osf_section_parallax_switcher'] === 'yes') {
            foreach ($repeater_list as $layer):
                ...
                if ($layer['osf_section_parallax_item_style'] == 'image') {
                    $html = '<img src="' . $layer['osf_section_parallax_image']['url'] . '" title="">';
                } else {
                    $html = $svgfile[$layer['osf_section_parallax_item_svg_style']];
                }
                $parallax_mouse = $layer['osf_section_parallax_mouse'] == 'yes' ? 'true' : 'false';
                echo '<div class="parallax-layer elementor-repeater-item-' . $layer['_id'] . $element->get_id() . ' f-' . $layer['osf_section_parallax_item_svg_color_type'] . '" data-parallax="' . $parallax_mouse . '" data-rate="' . $layer['osf_section_parallax_rate'] . '">' . $html . '</div>';
            endforeach;
            ?>
            <script type="text/javascript">
                (function ($) {
                    ...
                    $(' .elementor-repeater-item-<?php echo $layer['_id'];?><?php echo $element->get_id(); ?>').prependTo($('.elementor-element-<?php echo $element->get_id(); ?>')).css({
    ...
    public function register_controls($element, $args) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => __('Multi Parallax ', 'strollik5-core'),
                'tab'   => Controls_Manager::TAB_LAYOUT,
            ]
        );
        $element->add_control('osf_section_parallax_switcher',
            [
                'label' => __('Enable Parallax', 'strollik5-core'),
        ...
        $element->add_control(
            ...
            [
                'label'     => __('Parallax Items', 'strollik5-core'),
                ...
                'fields'    => [
                    [
                        ...
                        'label'   => __('Parallax Type', 'strollik5-core'),
                        'type'    => Controls_Manager::SELECT,
                        'options' => [
                            'image' => __('Image', 'strollik5-core'),
                            'svg'   => __('Opal Style', 'strollik5-core'),
                        ],
                        'default' => 'image',
                    ],
                    [
                        'name'      => 'osf_section_parallax_item_svg_style',
                        'label'     => __('Opal Style', 'strollik5-core'),
                        'type'      => Controls_Manager::SELECT,
                        'options'   => [
                            '0' => __('Style 1', 'strollik5-core'),
                            '1' => __('Style 2', 'strollik5-core'),
                            '2' => __('Style 3', 'strollik5-core'),
                            '3' => __('Style 4', 'strollik5-core'),
                        ],
                        'default'   => '1',
                        'condition' => [
                    ...
                    [
                        ...
                        'label'     => __('Opal Style Color', 'strollik5-core'),
                        'type'      => Controls_Manager::SELECT,
                        'options'   => [
                    ...
                    [
                        ...
                        'label'      => __('Custom Color', 'strollik5-core'),
                    ...
                    [
                        ...
                        'label'      => __('Position h', 'strollik5-core'),
                        'type'       => Controls_Manager::SLIDER,
                        'range'      => [
                            'px' => [
                                'min' => 0,
                    ...
                    [
                        ...
                        'label'      => __('Position v', 'strollik5-core'),
                        'type'       => Controls_Manager::SLIDER,
                        'range'      => [
                            'px' => [
                                'min' => 0,
                    ...
                    [
                        ...
                        'label'   => __('Background Size', 'strollik5-core'),
                        'type'    => Controls_Manager::SELECT,
                        'default' => 'auto',
                        'options' => [
                            'auto'    => __('Auto', 'strollik5-core'),
                            'cover'   => __('Cover', 'strollik5-core'),
                            'contain' => __('Contain', 'strollik5-core'),
                        ],
                    ],
                    [
                        'name'        => 'osf_section_parallax_z_index',
                        'label'       => __('Z-Index', 'strollik5-core'),
                        'type'        => Controls_Manager::NUMBER,
                        'default'     => 1,
                        'description' => __('Choose z-index for the parallax layer, default: 3', 'strollik5-core'),
                    ],
                    [
                        'name'        => 'osf_section_parallax_mouse',
                        'label'       => __('Mousemove Parallax', 'strollik5-core'),
                        'type'        => Controls_Manager::SWITCHER,
                        'description' => __('Enable or disable mousemove interaction', 'strollik5-core'),
                    ],
                    [
                        'name'    => 'osf_section_parallax_rate',
                        'label'   => __('Rate', 'strollik5-core'),
                        'type'    => Controls_Manager::NUMBER,
                        'default' => -10,
                        'min'     => -20,
                        'max'     => 20,
