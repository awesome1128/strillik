...
class OSF_Elementor_Section {
    ...
    public function register_controls($element, $args) {
        ...
        $element->start_controls_section(
            'section_sticky',
            [
                'label' => __('Sticky ', 'strollik5-core'),
        ...
        $element->add_control(
            'sticky_show',
            [
                'label'        => __('Enable Sticky', 'strollik5-core'),
    ...
    public function register_controls_advanced($element, $args) {
        ...
        $element->add_responsive_control(
            'sticky_padding',
            [
                'label'              => __('Padding Sticky', 'strollik5-core'),
                ...
                'description' => __( 'padding when sticky active', 'strollik5-core' ),
            ]
        );
    }
    ...
    public function register_controls_background($element, $args) {
        ...
        $element->add_control(
            ...
            [
                'label'     => __('Background Sticky Active', 'strollik5-core'),
