...
class OSF_Widget_Layered_Nav extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Display a list of attributes to filter products in your store.(OSF custom)', 'strollik5-core' );
        $this->widget_id          = 'otf_woocommerce_layered_nav';
        $this->widget_name        = __( 'OSF Filter Products by Attribute', 'strollik5-core' );
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'strollik5-core' ),
                'label' => __( 'Title', 'strollik5-core' ),
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'strollik5-core' ),
                'options' => $attribute_array,
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'strollik5-core' ),
                'options' => array(
            ...
            'style' => array(
                ...
                'options' => array(
                    'one_column'          => __( '1 Column', 'strollik5-core' ),
                    'two_columns'   => __( '2 Columns', 'strollik5-core' ),
                    'inline'        => __( 'Inline', 'strollik5-core' ),
                ),
            ),
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'strollik5-core' ),
                'options' => array(
                    'and' => __( 'AND', 'strollik5-core' ),
                    'or'  => __( 'OR', 'strollik5-core' ),
                ),
            ),
        );
    }
