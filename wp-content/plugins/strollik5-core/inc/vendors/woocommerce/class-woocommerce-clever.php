...
if (!class_exists('Strollik5_WooCommerce_Clever')) :


    class Strollik5_WooCommerce_Clever {
...
//                    update_option('woosw_button_position_single', '0');
        ...
        public function add_hook() {
            ...
            if (function_exists('woosq_init')) {
                if (get_option('woosq_button_position') == "0") {
                    add_action('woocommerce_before_shop_loop_item_title', [$this, 'quickview_button'], 20);
                }
            }
            ...
            if (function_exists('wooscp_init')) {
                if (get_option('_wooscp_button_archive') == "0") {
                    add_action('woocommerce_before_shop_loop_item_title', [$this, 'compare_button'], 30);
    ...
    return new Strollik5_WooCommerce_Clever();
endif;
