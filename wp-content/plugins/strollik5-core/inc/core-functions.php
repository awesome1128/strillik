...
function osf_get_google_fonts() {
    $content = file_get_contents(STROLLIK5_CORE_PLUGIN_DIR . 'webfonts.json');
...
function time_elapsed_string($datetime, $full = false) {
    ...
    $string = array(
        'y' => __('year', 'strollik5-core'),
        'm' => __('month', 'strollik5-core'),
        'w' => __('week', 'strollik5-core'),
        'd' => __('day', 'strollik5-core'),
//        'h' => __('hour', 'strollik5-core'),
//        'i' => __('minute', 'strollik5-core'),
//        's' => __('second', 'strollik5-core'),
    );
    ...
    return $string ? implode(', ', $string) . __(' left', 'strollik5-core') : __('just now', 'strollik5-core');
}
