...
class OSF_Metabox {
    ...
    private function page_meta_box_tabs() {
        ...
        $cmb2 = new_cmb2_box(array(
            ...
            'title'         => __('Page Setting', 'strollik5-core'),
            ...
            'tabs'          => array(
                ...
                array(
                    ...
                    'title'  => __('Breadcrumb', 'strollik5-core'),
                    'fields' => array(
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Sidebar', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Sidebar Width', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'             => __('Sidebar', 'strollik5-core'),
            'desc'             => 'Select sidebar',
            'id'               => $prefix . 'sidebar',
            'type'             => 'select',
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Page Title', 'strollik5-core'),
        ...
        if (osf_is_elementor_activated()) {
            $cmb2->add_field(array(
                'name'    => __('Enable Full Page', 'strollik5-core'),
        ...
        // Header
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Header', 'strollik5-core'),
        ...
        $headers = wp_parse_args($this->get_post_type_data('header'), array(
            'default' => esc_html__('Default', 'strollik5-core'),
        ));
        $cmb2->add_field(array(
            'name'             => __('Layout', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Breadcrumb', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Heading Color', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Text Color', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Background Color', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'         => __('Breadcrumb Background', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Footer', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Padding Top', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Fixed Footer', 'strollik5-core'),
    ...
    private function header_builder($prefix = 'osf_') {
        $cmb2 = new_cmb2_box(array(
            ...
            'title'        => __('Header Settings', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable AbHeader Absolute', 'strollik5-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Background Color Mobile', 'strollik5-core'),
