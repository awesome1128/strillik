...
class strollik5_setup_sidebar {
    ...
    public function init_sidebar(){
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'strollik5'),
            'id'            => 'sidebar-blog',
    ...
    public function set_sidebar($sidebar) {
        if (strollik5_is_product_archive() || (function_exists('is_product') && is_product())) {
        } else {
...
return new strollik5_setup_sidebar();